...
<head>
    <meta charset="utf-8" />
    <title>Mayor Dashboard | BOIS</title>
        ...
        <div id="page-content-wrapper">
            ...
            <h3 class="fs-4 mb-3 text-center py-3 dark-text fs-4 fw-bold text-uppercase border-bottom">Region 1 </h3>
                <div class="row g-3 my-2">
                    ...
                    <div class="col-md-6">
                    <h6  class="text-center">Total Population of Brgy. Officials in Ilocos Norte According to their Position</h6>
                ...
                <div class="row g-3 my-2">
                  ...
                  <div class="col-md-6">
                  <h6  class="text-center">Total Population of Brgy. Officials in Ilocos Sur According to their Position</h6>
                      <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
...
<?php include "../mayor/charts/chart_queries.php" ?>
<?php include "../../db_connection.php"; ?>
<?php include "../mayor/charts/ilocos_norte.php"; ?>
<?php include "../mayor/charts/ilocos_sur.php"; ?>
